...
BEGIN
  ...
  --
  -- IMPORTANTE (hallazgo real durante el backfill inicial, 2026-09-02): SIEMPRE en 2 pasadas
  -- separadas (ventas sin join de promo, promo con su propio join), NUNCA combinadas en una sola
  -- pasada con LEFT JOIN -- una linea de venta que matchea mas de una condicion comercial en
  -- CGD_CONDCOM_VTA_DET duplica el join, y si CANTIDAD se suma en esa misma pasada, queda inflada
  -- (medido: 322041 vs 322055 en un rango real con promos, antes de separar los pasos).
